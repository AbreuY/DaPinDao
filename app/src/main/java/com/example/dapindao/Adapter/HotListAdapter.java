...
public class HotListAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public HotListAdapter(Context context,JsonArray model){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hotlist_data, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if(viewHolder instanceof BodyViewHolder){
            ...
            String element =object.get("element").getAsString();
