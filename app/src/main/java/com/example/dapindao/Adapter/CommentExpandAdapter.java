...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    private List<ArticleDetailsModel.CommentResultBean.ListBean> commentBeanList;
    private List<ArticleDetailsModel.CommentResultBean.ListBean.SubListBean> replyBeanList;
    private Context context;
    private ArticleDetailsActivity activity;
    private int likeconut = 0;


    public CommentExpandAdapter(ArticleDetailsActivity activity,Context context, List<ArticleDetailsModel.CommentResultBean.ListBean> commentBeanList) {
     ...
     */
    public void addTheCommentData(ArticleDetailsModel.CommentResultBean.ListBean commentDetailBean){
     ...
     */
    public void dellTheCommentData(ArticleDetailsModel.CommentResultBean.ListBean commentDetailBean){
        if(commentDetailBean!=null){
     ...
     */
    public void addTheReplyData(ArticleDetailsModel.CommentResultBean.ListBean.SubListBean replyDetailBean, int groupPosition){
        if(replyDetailBean!=null){
            ...
            if(commentBeanList.get(groupPosition).getSubList() != null ){
                ...
                List<ArticleDetailsModel.CommentResultBean.ListBean.SubListBean> replyList = new ArrayList<>();
     ...
     */
    private void addReplyList(List<ArticleDetailsModel.CommentResultBean.ListBean.SubListBean> replyBeanList, int groupPosition){
        if(commentBeanList.get(groupPosition).getSubList() != null ){
