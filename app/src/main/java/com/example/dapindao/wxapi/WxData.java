package com.example.dapindao.wxapi;
...
public class WxData {
     ...
     *
     */
    public static final String WEIXIN_APP_ID = "wxedc39d2d62caf29e";
    public static final String APP_SECRET = "13971f67f11404ae4a7032be1cfaf086";
