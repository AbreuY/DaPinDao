...
public class SeriesPresenter implements AlertsInterface.Presenter{
    private SeriesFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public SeriesPresenter(SeriesFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new SeriesAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new SeriesAdapter.OnitemClickListener() {
                                @Override
