...
public class BoxofficePresenter implements AlertsInterface.Presenter{
    private BoxofficeFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public BoxofficePresenter(BoxofficeFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new BoxofficeAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new BoxofficeAdapter.OnitemClickListener() {
                                @Override
