...
public class OverseasPresenter implements AlertsInterface.Presenter{
    private OverseasFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public OverseasPresenter(OverseasFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new OverseasAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new OverseasAdapter.OnitemClickListener() {
                                @Override
