...
public class ShadowCastPresenter implements AlertsInterface.Presenter{
    private ShadowCastFragment fragment;
    private AlertsInterface.View view;
    public ShadowCastPresenter(ShadowCastFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new ShadowCastAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new ShadowCastAdapter.OnitemClickListener() {
                                @Override
