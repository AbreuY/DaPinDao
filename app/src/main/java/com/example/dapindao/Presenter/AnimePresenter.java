...
public class AnimePresenter implements AlertsInterface.Presenter{
    private AnimeFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public AnimePresenter(AnimeFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new AnimeAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new AnimeAdapter.OnitemClickListener() {
                                @Override
