...
public class WorkplacePresenter implements AlertsInterface.Presenter{
    private WorkplaceFragmnet fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public WorkplacePresenter(WorkplaceFragmnet fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new WorkplaceAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new WorkplaceAdapter.OnitemClickListener() {
                                @Override
