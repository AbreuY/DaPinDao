...
public class AdvertisingPresenter implements AlertsInterface.Presenter{
    private AdvertisingFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public AdvertisingPresenter(AdvertisingFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new AdvertisingAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new AdvertisingAdapter.OnitemClickListener() {
                                @Override
