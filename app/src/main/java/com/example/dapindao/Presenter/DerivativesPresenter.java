...
public class DerivativesPresenter implements AlertsInterface.Presenter{
    private DerivativesFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public DerivativesPresenter(DerivativesFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new DerivativesAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new DerivativesAdapter.OnitemClickListener() {
                                @Override
