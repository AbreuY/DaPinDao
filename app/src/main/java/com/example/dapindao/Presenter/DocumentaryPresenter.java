...
import com.example.dapindao.Adapter.DocumentaryAdapter;
...
import com.example.dapindao.View.AnimeFragment;
...
import com.example.dapindao.View.DocumentaryFragment;
...
import com.example.dapindao.View.VarietyFragmnet;
...
public class DocumentaryPresenter implements AlertsInterface.Presenter{
    private DocumentaryFragment fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public DocumentaryPresenter(DocumentaryFragment fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new DocumentaryAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new DocumentaryAdapter.OnitemClickListener() {
                                @Override
