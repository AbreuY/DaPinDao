...
public class VarietyPresenter implements AlertsInterface.Presenter{
    private VarietyFragmnet fragment;
    private AlertsInterface.View view;
    JsonArray jsonElements;
    public VarietyPresenter(VarietyFragmnet fragment,AlertsInterface.View view){
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(jsonObject.get("code").getAsInt() == 0){
                            ...
                            fragment.adapter = new VarietyAdapter(fragment.getContext(),jsonElements);
                            fragment.recyclerView.setAdapter(fragment.adapter);
                            fragment.adapter.setOnitemClickListener(new VarietyAdapter.OnitemClickListener() {
                                @Override
