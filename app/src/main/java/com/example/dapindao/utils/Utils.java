...
public class Utils {
    ...
    public static long getMainThreadId() {
        return DapinDaoApp.getMainThreadId();
    }
    /**
     * 得到主线程Handler
     *
    ...
    public static Handler getMainThreadHandler() {
        return DapinDaoApp.getMainHandler();
    }
    ...
    public static int dip2Px(int dip) {
        ...
        float density = DapinDaoApp.getContext().getResources().getDisplayMetrics().density;
