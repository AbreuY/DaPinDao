...
import com.example.dapindao.Adapter.BannerPagerAdapter;
import com.example.dapindao.R;
import com.example.dapindao.transformer.ZoomPageTransformer;
...
//    };
    ...
    public BannerViewPager initBanner(List<String> list,boolean isGallery){
        ...
        title_tv = (TextView) mLayout.findViewById(R.id.title_tv);
        //初始化位置
     ...
     * @param isGallery 是否使用3D画廊效果
     */
    public BannerViewPager initBanner(List<String> list,boolean isGallery,List<String> title){
        mList=list;
        mtitle = title;
        //引入布局
        mLayout = LayoutInflater.from(mContext).inflate( R.layout.banner_view_layout, null);
...
//    }
    ...
    public void onPageSelected(int position) {
        ...
        if(mtitle !=null){
            title_tv.setText(mtitle.get(currentIndex));
