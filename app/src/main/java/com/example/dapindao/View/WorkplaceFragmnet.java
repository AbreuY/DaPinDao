...
//职场
public class WorkplaceFragmnet extends Fragment implements AlertsInterface.View {
    @BindView(R.id.refreshLayout)
    public SmartRefreshLayout refreshLayout;
    @BindView(R.id.recyclerView)
    public RecyclerViewEmptySupport recyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    public WorkplaceAdapter adapter;
    private WorkplacePresenter presenter;
    int pagenum = 1;
    int pagesize = 10;
    public View view;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.workplace,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new WorkplacePresenter(this,this);
        presenter.recFront(13,pagenum,pagesize);
        return view;
    }
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(13,1,pagesize);
