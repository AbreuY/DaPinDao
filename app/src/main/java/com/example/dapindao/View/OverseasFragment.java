...
//海外
public class OverseasFragment extends Fragment implements AlertsInterface.View {
    @BindView(R.id.refreshLayout)
    public SmartRefreshLayout refreshLayout;
    @BindView(R.id.recyclerView)
    public RecyclerViewEmptySupport recyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    public OverseasAdapter adapter;
    private OverseasPresenter presenter;
    int pagenum = 1;
    int pagesize = 10;
    public View view;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.overseas,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new OverseasPresenter(this,this);
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(16,1,pagesize);
