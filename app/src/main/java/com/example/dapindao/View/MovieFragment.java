...
//电影
public class MovieFragment extends Fragment implements AlertsInterface.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.moviefragment,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new MoviePresenter(this,this);
        presenter.recFront(11,pagenum,pagesize);
        return view;
    }
