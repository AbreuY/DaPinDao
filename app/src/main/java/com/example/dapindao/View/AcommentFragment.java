...
//我评论的
public class AcommentFragment extends Fragment implements MycommentsInterface.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.acommentfragment,container,false);
        ButterKnife.bind(this,view);
        initUI();
        mycommentsPresenter = new MycommentsPresenter(this,getActivity(),recyclerView,adapter);
        mycommentsPresenter.queryOwnCommentPage(pagenum,pagesize,"2");
        return view;
    }
