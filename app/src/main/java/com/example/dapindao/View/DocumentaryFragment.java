...
import com.example.dapindao.Presenter.DocumentaryPresenter;
...
//纪录片
public class DocumentaryFragment extends Fragment implements AlertsInterface.View {
    @BindView(R.id.refreshLayout)
    public SmartRefreshLayout refreshLayout;
    @BindView(R.id.recyclerView)
    public RecyclerViewEmptySupport recyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    public DocumentaryAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.documentary,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new DocumentaryPresenter(this,this);
        presenter.recFront(21,pagenum,pagesize);
        return view;
    }
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(21,1,pagesize);
