...
//
public class VarietyFragmnet extends Fragment implements AlertsInterface.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.variety,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new VarietyPresenter(this,this);
        presenter.recFront(19,pagenum,pagesize);
        return view;
    }
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(19,1,pagesize);
