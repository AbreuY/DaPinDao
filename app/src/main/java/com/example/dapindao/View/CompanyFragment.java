...
//公司
public class CompanyFragment extends Fragment implements AlertsInterface.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.company,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new CompanyPresenter(this,this);
        presenter.recFront(10,pagenum,pagesize);
        return view;
    }
