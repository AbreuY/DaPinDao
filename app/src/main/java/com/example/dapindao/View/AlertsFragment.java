...
import com.example.dapindao.Presenter.AlertPresenter;
...
//快讯
public class AlertsFragment extends Fragment implements AlertsInterface.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.alerts,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new AlertPresenter(this,this);
        presenter.recFront(4,pagenum,pagesize);
        return view;
