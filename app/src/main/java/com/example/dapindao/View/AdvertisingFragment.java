...
//广告
public class AdvertisingFragment extends Fragment implements AlertsInterface.View {
    ...
    private AdvertisingPresenter presenter;
    int pagenum = 1;
    int pagesize = 10;
    public View view;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.advertising,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new AdvertisingPresenter(this,this);
        presenter.recFront(15,pagenum,pagesize);
        return view;
    }
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(15,1,pagesize);
