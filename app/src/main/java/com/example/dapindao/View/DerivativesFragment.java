...
//海外
public class DerivativesFragment extends Fragment implements AlertsInterface.View {
    @BindView(R.id.refreshLayout)
    public SmartRefreshLayout refreshLayout;
    @BindView(R.id.recyclerView)
    public RecyclerViewEmptySupport recyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    public DerivativesAdapter adapter;
    private DerivativesPresenter presenter;
    int pagenum = 1;
    int pagesize = 10;
    public View view;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.derivatives,container,false);
        ButterKnife.bind(this,view);
        initUI();
        presenter = new DerivativesPresenter(this,this);
        presenter.recFront(17,pagenum,pagesize);
        return view;
    }
    ...
    private void initUI(){
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.recFront(17,1,pagesize);
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                presenter.recFront(16,pagenum++,pagesize);
                JzvdStd.goOnPlayOnPause();
            }
        });
